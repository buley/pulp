...
var on_success = function(req,res) {
	...
	graphs.read( { datatype: 'index', index: 'something_new', key: 'random', value: rand, on_success: function(req,res){console.log("REQUEST",req,res);}, on_error: on_error, on_complete: on_complete } );
};
...
for ( var x = 0; x < 10; x += 1 ) {
	graphs.create( { datatype: 'index', id: id, index: 'something_new', data: { random: rand }, on_success: on_success, on_error: on_error } );
}
